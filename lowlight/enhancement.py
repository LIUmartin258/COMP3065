...
if __name__ == '__main__':
    img = cv2.imread('E:/COMP3065/lowlight/results/test/LOLv1/0051_rgb.png')
    nir = np.float32(cv2.imread('E:/COMP3065/lowlight/RGBNIR/0051_nir.tiff')[:, :, 0])
    ...
    cv2.waitKey(0)
    cv2.imwrite('E:/COMP3065/lowlight/results/test/LOLv1/result2.tiff', result)